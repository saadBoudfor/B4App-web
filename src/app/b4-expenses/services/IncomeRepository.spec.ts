...
//   beforeEach(() => {
//     const logger = jasmine.createSpyObj(['error', 'info', 'debug']);
//     const repository = jasmine.createSpyObj(['getAll', 'clearAll', 'save', 'delete', 'getByID']);
//     logger.error.and.callFake(console.error);
//     logger.info.and.callFake(console.log);
//     incomeService = new IncomeService(logger, repository);
